...
function WhyWe() {
  return (
    <div className=" max-w-7xl mx-auto bg-white  flex flex-col md:flex-row items-center justify-center mt-4 ">
      ...
      <div className="flex-1">
        <div className="text-center ">
          ...
          <p className="text-gray-600">
            ...
            Adipisci Saepa Quas Dolore Magni Quibusdam Placeat Deserunt. 
          </p>
        </div>
